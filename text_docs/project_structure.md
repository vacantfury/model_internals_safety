...
2. **Codename** for this paper. The series ID is **AS-6**, alias **E** (paper-ID standard owner-ratified 2026-08-03; the letter was reassigned 2026-08-02 from the retired "Smuggled Actions" = AS-5†; registry of record = science `portfolio.md`). No codename settled yet — optional, and cheap to defer to S2.
