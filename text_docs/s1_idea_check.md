...
| 4 | **Behavior** — did it refuse? | refusal / ASR, HarmBench classifier (preferred over Llama Guard 2 + substring, which mislabels degenerate completions) |
